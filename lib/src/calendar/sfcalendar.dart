...
class SfCalendar extends StatefulWidget {
  ...
  ///  }
  ///
  final Function()? loadMoreResoures;
...
class _SfCalendarState extends State<SfCalendar>
  ...
  void initState() {
    ...
    if (_resourcePanelScrollController != null) {
      _resourcePanelScrollController!.addListener(() {
        if (_resourcePanelScrollController!.position.pixels ==
            _resourcePanelScrollController!.position.maxScrollExtent) {
          if (widget.loadMoreResoures != null) {
            widget.loadMoreResoures!();
          }
        }
      });
    }
